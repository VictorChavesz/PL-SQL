...
DECLARE
  ...
  vBlobDestino     BLOB;
  vNomeArquivo     VARCHAR2(100) := 'Rocks_D._Xebec_Manga_Infobox.png';
...
BEGIN
  ...
  IF DBMS_LOB.FILEEXISTS(vArquivoOrigem) = 1 THEN
     ...
     VALUES (1, 'Rocks', 'D. Xebec', EMPTY_BLOB())
...
DECLARE
  ...
  vNomeArquivoDestino   VARCHAR2(100) := 'Rocks_D._Xebec_Manga_Infobox1.png';
